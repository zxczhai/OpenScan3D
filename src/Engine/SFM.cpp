...
int Reconstruction(std::string inputDir, std::string outputDir, std::string sfmEngine = "INCREMENTAL")
{
  OPENMVG_LOG_INFO
      << "\n-----------------------------------------------------------"
  ...
  // Common options:
  std::string
      filename_sfm_data = inputDir + "/sfm_data.json",
      directory_match = inputDir,
      filename_match = "matches_filtered.bin",
