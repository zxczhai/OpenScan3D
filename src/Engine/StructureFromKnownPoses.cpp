...
int StructureFromKnownPoses(std::string sfmDataDir, std::string feature_describeDir, std::string outputrobustDir, std::string matches_filteredDir, std::string on_off)
{
  ...
  std::string sMatchesDir = feature_describeDir;
  std::string sMatchFile = matches_filteredDir + "/matches_filtered.bin";
  std::string sPairFile;
  std::string sOutFile = outputrobustDir+"/robust.bin";
