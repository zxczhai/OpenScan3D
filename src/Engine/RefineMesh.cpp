...
bool Initialize(size_t argc, LPCTSTR* argv)
{
	...
	config.add_options()
		...
		("resolution-level", boost::program_options::value(&OPT::nResolutionLevel)->default_value(1), "how many times to scale down the images before mesh refinement")
...
int RefineMesh(int num,char* cmd[])
{
	int argc = num;
